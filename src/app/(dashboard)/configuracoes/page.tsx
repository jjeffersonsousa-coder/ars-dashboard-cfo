  ...
  return (
    <div className="space-y-6">
      ...
      {tab === "integracoes" && (
        <div className="space-y-4 max-w-lg">
          <div className="rounded-xl p-4 text-sm" style={{ backgroundColor: "#E8F1F2", border: "1px solid #D4E8F0" }}>
            <p className="font-semibold text-slate-700 mb-1">Base IA — Chave Groq (gratuito)</p>
            <p className="text-slate-600">A chave é armazenada apenas no seu navegador (localStorage) e usada para responder perguntas no menu Help / Base IA com respostas diretas via Llama 3.3 70B (Groq). Obtenha sua chave gratuita em console.groq.com.</p>
          </div>
          <div className="rounded-xl p-5 space-y-3" style={{ border: "1px solid #E2E8F0", background: "#F8FAFC" }}>
            <label className="block text-sm font-medium text-slate-700">Chave de API Groq</label>
            ...
            {claudeKeySaved && (
              <p className="text-xs font-medium" style={{ color: "#16A34A" }}>
                ✓ Chave salva com sucesso. O Help / Base IA já usará o Groq (Llama 3.3) para responder.
              </p>
            )}
